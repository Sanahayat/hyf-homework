...
var server = http.createServer((req, res) => {
    ...
    //...4
    if (url == '/addNewStudent' && req.method == 'POST') {
        console.log("---adding a new student to HYF---");
        //JSON.stringify(hyf_students.addNewStudent({ "name": "Abed Sujan", "classId": '09', "email": "abed@abc.com", "phone": "(455) 111-1114" }));
    ...
    if (url == '/editStudentInfo') {
        ...
        res.end('Oopssssssss:Unable to do that!')
    }
